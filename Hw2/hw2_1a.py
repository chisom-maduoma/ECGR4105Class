#Homework 2, Problem 1a - Develop Gradient Descent Algorithm to predict house prices based on area, bedrooms, bathrooms, stories, and parking
import pandas as pd
import numpy as np
...
x = data[['area', 'bedrooms', 'bathrooms', 'stories', 'parking']].values #area, bedrooms, bathrooms, stories, parking
