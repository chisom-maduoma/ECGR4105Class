#Homework 2, Problem 3b - Adding penalty to the loss using code from Problem 2b
import pandas as pd
import numpy as np
...
x_train, x_test, y_train, y_test = train_test_split(x_stan_b, y, test_size=0.2, random_state=42) #80% training, 20% testing
...
for alpha in learning_rates:
    theta, train_loss, valid_loss = gradient_descent(x_train, x_test, y_train, y_test, alpha=alpha, iterations=1000, lam=0.1)
